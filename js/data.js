...
export const stack = ['BigQuery','Kubernetes','Apache Spark','dbt','Snowflake','GCP','AWS','Databricks','Python','Docker','Terraform','Kafka','Soda','LangChain','n8n','PostgreSQL','Redshift','Helm','Git'];
